...
ix.config.Add("startingAttMax", 3, "The max amount of points you can put into an attribute during char creation specifically.", nil, {
	data = { min = 0, max = 100 },
	category = "characters"
})

ix.config.Add("startingSkillMax", 3, "The max amount of points you can put into a skill during char creation specifically.", nil, {
	data = { min = 0, max = 100 },
	category = "characters"
})