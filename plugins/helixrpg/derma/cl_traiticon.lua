...
function PANEL:OnCursorEntered()
  if not self.Activated and self.Selectable then
...
function PANEL:OnCursorExited()
  if not self.Activated and self.Selectable then self:SetColor(self.InactiveColor) end
end

function PANEL:DoClick()
  if self.Selectable then
    surface.PlaySound("helix/ui/press.wav")
    self:SetActivated(not self.Activated)
  end
