...
function ITEM:OnEquipped()
    ...
    -- Set glasses strength if not already set
    if self:GetData("st", 0) == 0 then
        self:SetData("st", character:GetData("eStr", 0))
    end

    -- Adjust perception based on glasses strength
    ...
    -- Apply COOL penalty (-2)
    character:AddBoost("glasses", "cool", -2)
end
...
function ITEM:OnUnequipped()
    ...
    -- Remove COOL penalty
    character:RemoveBoost("glasses", "cool")
end